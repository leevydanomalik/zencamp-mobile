        ...
        <ThemeProvider>
              <View   style={{flex:1, backgroundColor:'#90EE90'}}>
                ...
                <View style={{backgroundColor:'#E0FFFF', width: 330, marginHorizontal: 15, marginTop: 5}}>
                  <Text>ID Order : {data && data.customerID}</Text>
                  <Text>No.telepon: {data && data.noTelp}</Text>
                  <Text>Nama Customer: {data && data.customerName}</Text>
                  <Text>Alamat Pengambilan: {data && data.alamatAsal}</Text>
                  <Text>Tujuan Pengiriman: {data && data.alamatTujuan}</Text>
                  <Text>Material KIMAP: {data && data.materialKIMAP}</Text>
                  <Text>Nama Material: {data && data.materialName}</Text>
                  <Text>Quantity: {data && data.orderQty}</Text>
                  <Text>Total Tagihan: {data && data.materialPrice*data.orderQty}</Text>
                  <Text>Waktu Pemesanan: {data && data.orderDate}</Text>          
                </View>  
                <View style={styles.title_detail}>
